...
dataset_val = ade20k.NSFGPoisonADE20k(root, transforms=trans_val, subset='validation')
dataset_val_poisoned = ade20k.NSFGPoisonADE20k(root, transforms=trans_val_poisoned, subset='validation_poisoned')
